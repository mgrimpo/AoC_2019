...
public class IntCodeMachineTest {
  ...
  public void testJumpIfTrueInstruction() {
    var exampleProgramWithJump = new int[]{115, 1, 6, -1, 0, 0, 99};
    var jumpIfTrueInstruction = new JumpIfTrueInstruction(exampleProgramWithJump, 0);
    assertEquals(jumpIfTrueInstruction.execute(exampleProgramWithJump).get(), 99);
    var exampleProgramWithOutJump = new int[]{115, 0, 6, 1, 0, 0, 0, 99};
    ...
    // TODO: test positional parameter mode
  }
