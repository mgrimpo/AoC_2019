...
public class Day6Test {
  ...
  public void testOrbitalTransfers() {
    var orbitalDistanceExample = "COM)B\n"
        + "B)C\n"
        + "C)D\n"
        + "D)E\n"
        + "E)F\n"
        ...
        + "K)YOU\n"
        + "I)SAN";
    var map = new Day6.OrbitMap(orbitalDistanceExample);
    assertEquals(4, map.orbitalTransfers("YOU", "SAN"));
    assertEquals(6, map.orbitalTransfers("YOU", "H"));
  }
